    ...
    T: fmt::Debug,
{
    ...
    parse(day, parser, sep, Some(7), true, ".")
}

/// A vec of all the positive integers in text, ignoring non-number characters.
...
pub fn trunc_default(s: &str) -> String {
    trunc(s, 70, 25, " ... ")
}
